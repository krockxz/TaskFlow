    ...
    return (
      <button
        ...
        className={cn(
          ...
          `transform-gpu transition-transform duration-[${ANIMATION_DURATION.NORMAL}ms] ease-in-out active:translate-y-px`,
          className
        )}
        ref={ref}
        {...props}
      >
        ...
        <div
          className={cn(
            ...
            // transition
            `transform-gpu transition-all duration-[${ANIMATION_DURATION.NORMAL}ms] ease-in-out`,
